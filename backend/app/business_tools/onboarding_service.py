...
async def check_kyc(customer_id: str) -> dict[str, Any]:
...
async def check_credit(customer_id: str) -> dict[str, Any]:
    customer = CUSTOMERS.get(customer_id)
    if not customer:
        return {"status": "error", "message": "Customer not found"}
...
async def verify_documents(customer_id: str) -> dict[str, Any]:
    customer = CUSTOMERS.get(customer_id)
    if not customer:
        return {"status": "error", "message": "Customer not found"}
    return {
