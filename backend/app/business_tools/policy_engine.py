...
async def check_policy(policy_id: str, context: dict[str, Any]) -> dict[str, Any]:
...
async def get_all_policies() -> list[dict[str, Any]]:
    return [
        {"id": pid, **p} for pid, p in POLICIES.items()
    ]
